...
#CURRENT_NAMESPACE = "myblog_post_current_config"
CURRENT_NAMESPACE = "myblog"
POSTS_LIST_TRUNCWORDS_COUNT = 100
PAGINATION = 10
USE_PLACEHOLDER = True
CURRENT_POST_IDENTIFIER = "myblog_post_current"
...
class BaseBlogView(AppConfigMixin, ViewUrlMixin):
    ...
    def get_queryset(self):
        ...
        setattr(self.request, CURRENT_NAMESPACE, self.config)
        return self.optimize(queryset.on_site())

    def get_template_names(self):
        template_path = (self.config and self.config.template_prefix) or "myblog"
...
class BaseBlogListView(BaseBlogView):
    ...
    #template_name = "oeilly_myblog/blog_homepage.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["TRUNCWORDS_COUNT"] = POSTS_LIST_TRUNCWORDS_COUNT
        return context

    def get_paginate_by(self, queryset):
        return (self.config and self.config.paginate_by) or PAGINATION
...
class PostDetailView(TranslatableSlugMixin, BaseBlogView, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["use_placeholder"] = USE_PLACEHOLDER
        setattr(self.request, CURRENT_POST_IDENTIFIER, self.get_object())
        return context


#the view of all aticles
