...
def media_plugins(context, post):
    """
    Extract :py:class:`myblog.media.base.MediaAttachmentPluginMixin`
    ...
    :type post: :py:class:`myblog.models.Post`
    :return: list of :py:class:`myblog.media.base.MediaAttachmentPluginMixin` plugins
    :rtype: List[myblog.media.base.MediaAttachmentPluginMixin]
    """
...
def media_images(context, post, main=True):
    ...
    :py:class:`myblog.media.base.MediaAttachmentPluginMixin`
    plugins in the ``media`` placeholder of the provided post.
    Support ``myblog-video`` ``poster`` field in case the plugin
