# Generated by Django 3.1.13 on 2021-10-29 18:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_config', aldryn_apphooks_config.fields.AppHookConfigField(help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='app_config', to='cms_myblog.blogconfig', verbose_name='app. config')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_config', aldryn_apphooks_config.fields.AppHookConfigField(help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_app_config', to='cms_myblog.blogconfig', verbose_name='app. config')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='post_author', to=settings.AUTH_USER_MODEL, verbose_name='author')),
                ('categories', models.ManyToManyField(blank=True, related_name='blog_posts', to='myblog.BlogCategory', verbose_name='category')),
                ('content', cms.models.fields.PlaceholderField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_contents', slotname='post_content', to='cms.placeholder')),
                ('liveblog', cms.models.fields.PlaceholderField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_live_blog', slotname='live_blog', to='cms.placeholder')),
                ('main_image', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='post_main_image', to=settings.FILER_IMAGE_MODEL, verbose_name='main image')),
                ('main_image_full', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='post_main_image_full', to='filer.thumbnailoption', verbose_name='main image full')),
                ('main_image_thumbnail', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='post_image_thumbnail', to='filer.thumbnailoption', verbose_name='main image thumbnail')),
                ('media', cms.models.fields.PlaceholderField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_media', slotname='media', to='cms.placeholder')),
                ('related', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, to='myblog.Post', verbose_name='Related Posts')),
                ('sites', models.ManyToManyField(blank=True, help_text='Select sites in which to show the post. If none is set it will be visible in all the configured sites.', related_name='post_sites', to='sites.Site', verbose_name='Site(s)')),
                ('tags', taggit_autosuggest.managers.TaggableManager(blank=True, help_text='Type a tag and hit tab, or start typing and select from autocomplete list.', related_name='post_tags', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_config', aldryn_apphooks_config.fields.AppHookConfigField(blank=True, help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='latest_basePostPlugin_app_conf', to='cms_myblog.blogconfig', verbose_name='app. config')),
                ...
                ('tags', taggit_autosuggest.managers.TaggableManager(blank=True, help_text='Show only the blog articles tagged with chosen tags.', related_name='latest_post_tags', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='filter by tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_site', models.BooleanField(default=True, help_text='Select items from the current site only', verbose_name='current site')),
                ('template_folder', models.CharField(choices=[('plugins', 'Default template')], default='plugins', help_text='Select plugin template to load for this instance', max_length=200, verbose_name='Plugin template')),
                ('app_config', aldryn_apphooks_config.fields.AppHookConfigField(blank=True, help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='basePostPlugin_app_conf', to='cms_myblog.blogconfig', verbose_name='app. config')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_config', aldryn_apphooks_config.fields.AppHookConfigField(blank=True, help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author_basePostPlugin_app_conf', to='cms_myblog.blogconfig', verbose_name='app. config')),
